...
if (!isset($_SESSION['user_id']) && !isset($_SESSION['admin_id'])) {
    header("Location: login.php?redirect=java_notes_quiz.php");
    exit();
}
...
<head>
  ...
  <title>Java Notes Quiz — 15 Questions (15 min)</title>
...
<body>
  <div class="quiz-container">
    <h1>Java Notes — Quick Quiz</h1>

    <div id="start-screen" class="card">
      <h2>Ready? 15 Questions — 15 Minutes</h2>
      <p>Based on the Java notes. Select an option and it will immediately show feedback. You may attempt the quiz maximum 3 times.</p>
  ...
  <script src="java_notes_quiz.js" defer></script>
</body>
</html>
